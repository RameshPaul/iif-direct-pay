package com.iif.directpay.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.iif.directpay.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.iif.directpay.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
/**
 * REST controller for managing {@link com.iif.directpay.domain.UserOrganization}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<UserOrganization> partialUpdateUserOrganization(
        ...
        Optional<UserOrganization> result = userOrganizationRepository
            ...
            .map(existingUserOrganization -> {
                if (userOrganization.getJoiningDate() != null) {
                    existingUserOrganization.setJoiningDate(userOrganization.getJoiningDate());
                }
                if (userOrganization.getExitDate() != null) {
                    existingUserOrganization.setExitDate(userOrganization.getExitDate());
                }
                if (userOrganization.getStatus() != null) {
                    existingUserOrganization.setStatus(userOrganization.getStatus());
                }
                if (userOrganization.getSuspendedDate() != null) {
                    existingUserOrganization.setSuspendedDate(userOrganization.getSuspendedDate());
                }
                if (userOrganization.getDeletedDate() != null) {
                    existingUserOrganization.setDeletedDate(userOrganization.getDeletedDate());
                }
                if (userOrganization.getCreatedDate() != null) {
                    existingUserOrganization.setCreatedDate(userOrganization.getCreatedDate());
                }
                if (userOrganization.getUpdatedDate() != null) {
                    existingUserOrganization.setUpdatedDate(userOrganization.getUpdatedDate());
                }
